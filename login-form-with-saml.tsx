...
export default function LoginFormWithSAML() {
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
            <Card className="w-full max-w-md">
                ...
                <CardContent className="space-y-4">
                    ...
                    {/* Selector de protocolo de autenticación */}
                    <div className="p-4 bg-gray-50 rounded-lg border border-gray-100">
                        <h3 className="text-sm font-medium mb-2">Protocolos de autenticación:</h3>
                        <div className="space-y-3">
                            ...
                            <SAMLLoginButton className="w-full" idpName="Okta (SAML 2.0)" />

                            <div className="text-xs text-gray-500 mt-1 space-y-1">
                                <p>• OIDC: Recomendado para aplicaciones modernas</p>
                                <p>• SAML: Compatible con sistemas legacy</p>
                            </div>
                        </div>
                    </div>
